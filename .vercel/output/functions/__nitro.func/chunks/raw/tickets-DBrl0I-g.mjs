...
import { getDocs, query, collection, where, doc, runTransaction, updateDoc } from 'firebase/firestore';
...
var ticketsService = {
  ...
  async checkInTicket(qrToken, volunteerId) {
    ...
    if (ticket.status === "cancelled")
      throw new Error("Ticket was cancelled");
    ...
    if (ticket.user_email)
      import('./ticket-emails-CQbKuzYy.mjs').then(({ sendScanConfirmation }) => {
