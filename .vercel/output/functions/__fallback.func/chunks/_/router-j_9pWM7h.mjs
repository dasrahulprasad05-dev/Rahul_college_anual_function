...
import { createFileRoute, lazyRouteComponent, createRouter, createRootRouteWithContext, useRouter, Link, Outlet, HeadContent, Scripts, redirect } from '@tanstack/react-router';
