...
import { doc, collection, setDoc, getDocs, deleteDoc, updateDoc, getDoc, query, orderBy, where } from 'firebase/firestore';

var eventsService = {
  async getEvents(publishedOnly = false) {
    const eventsRef = collection(db, "events");
    let q = query(eventsRef, orderBy("event_date", "asc"));
    if (publishedOnly) q = query(eventsRef, where("is_published", "==", true), orderBy("event_date", "asc"));
